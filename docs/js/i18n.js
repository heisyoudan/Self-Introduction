...
(() => {
  ...
  const DICTS = {
    "ja": {
      ...
      "about.title": "自己紹介",
      "common.back": "戻る",
      "about.body_html": "初めまして、何暁丹と申します。<br><br>中国の武漢出身で、2022年10月に来日して以来、日本語を学習してまいりました。現在は日本語能力試験N2に合格し、業務における読み書き・会話に支障はありません。<br><br>これまで中国ではUnityプログラマーとして4年間、建設・製造分野向けの産業用VRシステム開発に従事し、要件定義から実装、システムテストまで一貫して担当しておりました。外部デバイス連携やシステム開発の経験も豊富です。<br><br>来日後はJava、SpringBoot、SpringMVCを中心にバックエンド開発に取り組み、フロントエンドではHTML / CSS / JavaScript / Reactを用いた開発を行いました。データベースではCRUD操作に加え、複雑なSQLクエリやパフォーマンス調整にも対応できます。<br><br>直近のプロジェクトでは、<b>Kickflowと連携した大規模決済代行サービスシステム</b>に参画し、基本設計から結合テストまで一連の工程を担当しました。AWS環境での開発、BFF・BE・共通モジュールの設計、API開発やS3連携、DB設計など幅広い領域を担当し、コードレビューやチーム開発にも積極的に貢献しました。<br><br>常に新しい技術を学び、自己研鑽を続けながら、チームに貢献できるエンジニアを目指しています。<br>どうぞよろしくお願いいたします。",
      ...
      "projects.item3.body_html": "高所作業中の墜落事故をVRで完全再現し、恐怖の疑似体験を通じて事故を未然に防ぐことを目的としています。ヘッドマウントディスプレイとヘッドフォンのみで、難しいセッティングなしに体験できます。",
    ...
    "zh": {
      ...
      "projects.item3.body_html": "完整还原高处作业的坠落事故，通过沉浸式“恐惧体验”来提升安全意识、预防事故。仅需头显与耳机，无需复杂设置即可体验。",
